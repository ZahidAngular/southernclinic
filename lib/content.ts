...
export const AFTER_HOURS = [
  ...
  {
    label: "National Home Doctor Service:",
    value: "13 74 25",
    href: "tel:137425",
    note: "(for a home visit)",
  },
  {
    label: "Hello Home Doctors Service:",
    value: "134 100",
    href: "tel:134100",
    note: "Book online (for a home visit)",
  },
  {
    label: "MedVisit Home Doctor Service:",
    value: "1300 3733 47",
    href: "tel:1300373347",
    note: "(for a home visit)",
  },
...
/* Fees page ------------------------------------------------------------- */
/* Each cell is a list of lines — the live table breaks them explicitly, which
   is what gives every row its three-line height. */
export const FEES_HEAD: string[][] = [
  ["P Number"],
  ...
  ["Short Phone Consult", "91890 level", "A gap"],
  ["Standard Phone Consult", "91891 level", "B gap"],
];

export const FEES_ROWS: string[][][] = [
  [
    ["P1"],
    ["$56.00", "$35.45 (Gap)", "$20.55 (Rebate)"],
    ["$90.00", "$44.95 (Gap)", "$45.05 (Rebate)"],
    ["$130.00", "$42.90 (Gap)", "$87.10 (Rebate)"],
    ["$172.00", "$43.65 (Gap)", "$128.35 (Rebate)"],
    ["Item 3", "$56.00 (non Conc)", "$37.00 (conc)"],
    ["$48.40", "$27.85 (Gap)", "$20.55 (Rebate)"],
    ["$73.00", "$27.95 (Gap)", "$45.05 (Rebate)"],
  ],
  [
    ["P2"],
    ["$52.00", "$31.45 (Gap)", "$20.55 (Rebate)"],
    ["$85.00", "$39.95 (Gap)", "$45.05 (Rebate)"],
    ["$125.00", "$37.90 (Gap)", "$87.10 (Rebate)"],
    ["$168.00", "$39.65 (Gap)", "$128.35 (Rebate)"],
    ["Item 23", "$90.00 (non Conc)", "$70.00 (conc)"],
    ["$43.40", "$22.85 (Gap)", "$20.55 (Rebate)"],
    ["$67.00", "$21.95 (Gap)", "$45.05 (Rebate)"],
  ],
  [
    ["P3"],
